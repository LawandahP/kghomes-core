    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_rent', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('unit_type', models.CharField(blank=True, choices=[('1+ Bedrooms', '1+ Bedrooms'), ('Studio', 'Studio'), ('Single Room', 'Single Room'), ('Shop', 'Shop'), ('Office', 'Office'), ('Warehouse', 'Warehouse'), ('Garage', 'Garage'), ('Restaurant', 'Restaurant'), ('Clinic', 'Clinic')], max_length=50, null=True)),
